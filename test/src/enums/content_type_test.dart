...
void main() {
  group('ContentType', () {
    test('has correct string values for JSON serialization', () {
      ...
      expect(ContentType.topic.name, 'category');
    ...
    test('can be created from string values', () {
      ...
      expect(ContentType.values.byName('category'), ContentType.topic);
    ...
    test('has correct toString representation', () {
      ...
      expect(ContentType.topic.toString(), 'ContentType.category');
