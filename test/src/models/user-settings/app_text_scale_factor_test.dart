...
void main() {
  group('AppTextScaleFactor', () {
    ...
    test('can be created from string values', () {
      expect(AppTextScaleFactor.values.byName('small'), AppTextScaleFactor.small);
      expect(AppTextScaleFactor.values.byName('medium'), AppTextScaleFactor.medium);
      expect(AppTextScaleFactor.values.byName('large'), AppTextScaleFactor.large);
      expect(AppTextScaleFactor.values.byName('extraLarge'), AppTextScaleFactor.extraLarge);
    });
    ...
    test('has correct toString representation', () {
      ...
      expect(AppTextScaleFactor.extraLarge.toString(), 'AppTextScaleFactor.extraLarge');
    });
  });
}
