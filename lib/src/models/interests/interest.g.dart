...
Interest _$InterestFromJson(Map<String, dynamic> json) => $checkedCreate(
  'Interest',
  json,
  ($checkedConvert) {
    final val = Interest(
      ...
      isFeedFilter: $checkedConvert('isFeedFilter', (v) => v as bool),
...
Map<String, dynamic> _$InterestToJson(Interest instance) => <String, dynamic>{
  ...
  'isFeedFilter': instance.isFeedFilter,
