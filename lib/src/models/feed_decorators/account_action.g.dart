    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        final val = AccountAction(
          ...
          callToActionUrl: $checkedConvert(
            'call_to_action_url',
            (v) => v as String?,
          ),
...
Map<String, dynamic> _$AccountActionToJson(
  ...
  if (_$AccountActionTypeEnumMap[instance.accountActionType] case final value?)
    'account_action_type': value,
  if (instance.callToActionText case final value?) 'call_to_action_text': value,
  if (instance.callToActionUrl case final value?) 'call_to_action_url': value,
};
