...
AdConfig _$AdConfigFromJson(Map<String, dynamic> json) => $checkedCreate(
  ...
  ($checkedConvert) {
    final val = AdConfig(
      ...
      guestAdPlacementInterval: $checkedConvert(
        'guest_ad_placement_interval',
        (v) => (v as num).toInt(),
      ),
      authenticatedAdFrequency: $checkedConvert(
        'authenticated_ad_frequency',
        (v) => (v as num).toInt(),
      ),
      ...
      premiumAdFrequency: $checkedConvert(
        'premium_ad_frequency',
        (v) => (v as num).toInt(),
      ),
      premiumAdPlacementInterval: $checkedConvert(
        'premium_ad_placement_interval',
        (v) => (v as num).toInt(),
      ),
  ...
  fieldKeyMap: const {
    ...
    'authenticatedAdPlacementInterval': 'authenticated_ad_placement_interval',
