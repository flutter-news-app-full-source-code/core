...
UserPreferenceConfig _$UserPreferenceConfigFromJson(
  ...
  ($checkedConvert) {
    final val = UserPreferenceConfig(
      guestFollowedItemsLimit: $checkedConvert(
        'guest_followed_items_limit',
        (v) => (v as num).toInt(),
      ),
      guestSavedHeadlinesLimit: $checkedConvert(
        'guest_saved_headlines_limit',
        (v) => (v as num).toInt(),
      ),
      ...
      premiumFollowedItemsLimit: $checkedConvert(
        'premium_followed_items_limit',
        (v) => (v as num).toInt(),
      ),
      premiumSavedHeadlinesLimit: $checkedConvert(
        'premium_saved_headlines_limit',
        (v) => (v as num).toInt(),
      ),
    );
    return val;
  ...
  fieldKeyMap: const {
    ...
    'authenticatedSavedHeadlinesLimit': 'authenticated_saved_headlines_limit',
