...
AppConfig _$AppConfigFromJson(Map<String, dynamic> json) => $checkedCreate(
  ...
  ($checkedConvert) {
    final val = AppConfig(
      ...
      disabledMessage: $checkedConvert('disabled_message', (v) => v as String?),
      minAllowedAppVersion: $checkedConvert(
        'min_allowed_app_version',
        (v) => v as String?,
      ),
      latestAppVersion: $checkedConvert(
        'latest_app_version',
        (v) => v as String?,
      ),
...
Map<String, dynamic> _$AppConfigToJson(AppConfig instance) => <String, dynamic>{
  ...
  if (instance.latestAppVersion case final value?) 'latest_app_version': value,
  ...
  if (instance.androidStoreUrl case final value?) 'android_store_url': value,
};
