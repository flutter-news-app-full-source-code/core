...
/// {@template headline_filter_criteria_summary}
...
/// {@endtemplate}
class HeadlineFilterCriteriaSummary extends Equatable {
  /// {@macro headline_filter_criteria_summary}
  const HeadlineFilterCriteriaSummary({
  ...
  /// Creates a [HeadlineFilterCriteriaSummary] from a full [HeadlineFilterCriteria].
  factory HeadlineFilterCriteriaSummary.fromCriteria(
    ...
    return HeadlineFilterCriteriaSummary(
  ...
  /// values.
  HeadlineFilterCriteriaSummary copyWith({
