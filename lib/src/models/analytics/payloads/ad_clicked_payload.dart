...
/// {@template ad_clicked_payload}
/// Payload for the `adClicked` analytics event.
/// {@endtemplate}
class AdClickedPayload extends AnalyticsEventPayload {
  /// {@macro ad_clicked_payload}
  const AdClickedPayload({
