...
/// {@template filter_updated_payload}
/// Payload for the `filterUpdated` analytics event.
///
...
/// {@endtemplate}
class FilterUpdatedPayload extends AnalyticsEventPayload {
  /// {@macro filter_updated_payload}
  const FilterUpdatedPayload({
  ...
  final FilterCriteriaSummary? newCriteriaSummary;
